...
knowledge0 = And(
    Or(AKnight,AKnave),#既是说谎又是骑士
    Implication(AKnave,Not(AKnight)),# A是说谎者，则不是骑士
    Implication(AKnight,Not(AKnave)),
    Implication(AKnave,Not(Puzzle0_Asays)),#如果是说谎者那么陈述就是假的
    Implication(AKnave,Puzzle0_Asays)
)
...
knowledge1 = And(
    Or(AKnight, AKnave),# A骑士或者说谎者
    Implication(AKnave, Not(AKnight)),
    Implication(AKnight, Not(AKnave)),#如果a是其实则不是说谎者
    Or(BKnight, BKnave),
...
knowledge3 = And(
    Or(AKnight, AKnave),#a是骑士或者说谎者
    Implication(AKnave, Not(AKnight)),
    Implication(AKnight, Not(AKnave)),
    Or(BKnight, BKnave),#b是其实或者说谎者
    Implication(BKnave, Not(BKnight)),
    Implication(BKnight, Not(BKnave)),
    Or(CKnave, CKnight),#c是其实或者说谎者
